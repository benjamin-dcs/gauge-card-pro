...
| `needle_shapes`                          | [needle_shapes object](#needle-shapes-configuration-variables) |                             | Configuration of the shapes of the needles                                                                                                                                                  | ✔️                                                                          |
...
| `value` | value corresponding to the type                | Required             | Value of the needle                          | ✔️ (only in code-editor/yaml)                                               |
|         |                                                |                      | • `entity`: Setpoint entity_id               |                                                                             |
|         |                                                |                      | • `number`: Fixed number                     |                                                                             |
...
| `main_with_inner`        | string | `M -49 -2 L -40 0 L -49 2 z`                  | Shape of the main gauge needle **with** inner gauge       | ✔️                                                                          |
| `main_setpoint`          | string | `M -49 -2 L -40 0 L -49 0 z`                  | Shape of the setpoint needle of the main gauge            | ✔️                                                                          |
| `inner`                  | string | `M -27.5 -1.5 L -32 0 L -27.5 1.5 z`          | Shape of the inner gauge needle                           | ✔️                                                                          |
| `inner_setpoint`         | string | `M -27.5 -1.5 L -32 0 L -27.5 0 z`            | Shape of the setpoint needle of the inner gauge           | ✔️                                                                          |
| `inner_on_main`          | string | `M -30 -1.5 L -34.5 0 L -30 1.5 z`            | Shape of the `on_main` inner gauge needle                 | ✔️                                                                          |
| `inner_setpoint_on_main` | string | `M -30 -1.5 L -34.5 0 L -30 0 z`              | Shape of the `on_main` setpoint needle of the inner gauge | ✔️                                                                          |
