...
- [Configuration variables](#configuration-variables)
  ...
  - [Value-Texts Configuration variables](#value-texts-configuration-variables)
    - [Value-Text Configuration variables](#value-text-configuration-variables)
...
| `layout`              | string                                                                | `default`                   | Layout of the gauge. Valid values are `default` and `equal`.                                                                                                    |                                                                             |
| `needle_style`        | string                                                                | `default`                   | Needle style to use. Valid values are `default` and `ha`.                                                                                                       |                                                                             |
...
| `needle_color`        | [string or map<sup>1</sup>](#1-color-examples)                        | `var(--primary-text-color)` | Color of the needle                                                                                                                                             | ✔️                                                                          |
| `segments`            | [list<sup>2</sup>](#2-segments-examples)                              | Optional                    | List of colors and their corresponding start values                                                                                                             | ✔️                                                                          |
...
| `animation_speed`     | string                                                                | `normal`                    | Animation speed of value elements. Valid values are `normal`, `fast` and `off`                                                                                  |                                                                             |
...
| `color`       | [string or map<sup>1</sup>](#1-color-examples) | `rgb(255, 255, 255)` | Color of the min or max indicator                                            |                                                                             |
...
|             |                                                |                      | • `number`: Fixed number                                                     |                                                                             |
|             |                                                |                      | • `template`: Template that returns a number                                 | ✔️                                                                          |
| `color`     | [string or map<sup>1</sup>](#1-color-examples) | `var(--error-color)` | Color of the needle                                                          | ✔️                                                                          |
| `label`     | boolean                                        | false                | Enables a label indicating the value (main gauge only)                       |                                                                             |
| `precision` | number                                         | Optional             | Amount of decimals to round the label to                                     |                                                                             |
...
| Name        | Type                                           | Default                                  | Description | [Templatable](https://www.home-assistant.io/docs/configuration/templating/) |
| :---------- | :--------------------------------------------- | :--------------------------------------- | :---------- | :-------------------------------------------------------------------------- |
| `value`     | string                                         | Optional                                 | Text value  | ✔️                                                                          |
| `color`     | [string or map<sup>1</sup>](#1-color-examples) | `var(--primary-text-color)`              | Color       | ✔️                                                                          |
| `font_size` | string                                         | `15px` for primary, `14px` for secondary | Font-size   | ✔️                                                                          |
...
| Name                  | Type                                                                                                    | Default                                                                                     | Description                                                   | [Templatable](https://www.home-assistant.io/docs/configuration/templating/) |
| :-------------------- | :------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------ | :------------------------------------------------------------ | :-------------------------------------------------------------------------- |
| `value`               | string                                                                                                  | `value` or state of `entity` for primary, `inner.value` or state of `entity2` for secondary | Text. Use `""` to overwrite the default                       | ✔️                                                                          |
| `color`               | [string or map<sup>1</sup>](#1-color-examples)                                                          | `var(--primary-text-color)`                                                                 | Color                                                         | ✔️                                                                          |
...
| `font_size_reduction` | number [0-15]                                                                                           | `0`                                                                                         | Value by which the value-text is reduced (only for `primary`) | ✔️ (only templatable in code-editor/yaml)                                   |
...
| `label_color`       | [string or map<sup>1</sup>](#1-color-examples)                                                          | `var(--primary-text-color)` | Color of the label                                                                                                                    | ✔️                                                                          |
| `tap_action`        | [Home Assistant Tap action](https://www.home-assistant.io/dashboards/actions/#tap-action)               |                             |                                                                                                                                       |                                                                             |
| `hold_action`       | [Home Assistant Hold action](https://www.home-assistant.io/dashboards/actions/#hold-action)             |                             |                                                                                                                                       |                                                                             |
| `double_tap_action` | [Home Assistant Double tap action](https://www.home-assistant.io/dashboards/actions/#double-tap-action) |                             |                                                                                                                                       |                                                                             |
