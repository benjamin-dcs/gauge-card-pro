...
this.path.parentNode.removeChild(this.path);}render(_ref2){let{type,stroke,strokeWidth,fill,width}=_ref2;// Store information from this render cycle
const renderCycle={};// Create a group for each element
const elemGroup=svgElem('g',{class:`element-${type}`});this.group.innerHTML="";this.group.appendChild(elemGroup);renderCycle.group=elemGroup;if(type==='path'){// If we specify a width and fill, then we need to outline the path and then average the join points of the segments
